...
import com.wax.extension.CustomTokenGranter;
...
//        CompositeTokenGranter compositeTokenGranter = new CompositeTokenGranter(granterList);
        CustomTokenGranter compositeTokenGranter = new CustomTokenGranter(granterList);
        endpoints
                .authenticationManager(authenticationManager)
    ...
    public DefaultTokenServices tokenServices(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        clientUserDetailsServiceMap.put(SecurityConstants.ADMIN_CLIENT_ID, customAdminUserDetailService); // 系统管理客户端
...
//        clientUserDetailsServiceMap.put(SecurityConstants.WEAPP_CLIENT_ID, memberUserDetailsService); // 微信小程序客户端
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(new ClassPathResource("jwt.jks"),
                "123456".toCharArray());
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            ResultData result = ResultData.customizeResult(ResultCode.INVALID_DATA_ERROR,
                    "dadadadadada");
